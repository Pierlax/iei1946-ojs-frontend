...
// Current Issue - Volume 79 Issue 1 - February 2026
export const CURRENT_ISSUE: Issue = {
  ...
  year: 2026,
  month: "February",
  publicationDate: "February 11, 2026",
  articles: [
    {
      id: 1465,
      title: "On European Fragmentation and the Single Currency in an Uncertain World",
      authors: [{ name: "Ignazio Visco", affiliation: "Governor Emeritus - Bank of Italy, Rome" }],
      abstract: "Europe faces growing strategic and economic challenges arising from the policies of the second Trump administration, extending beyond trade to energy, defence, digital services, and cross-border payments. Heightened uncertainty over US policy has raised concerns about the stability of the international monetary system and the future role of the dollar. In this context, some observers argue that the European Union could strengthen its geopolitical position and that the euro could assume a more prominent role as an international reserve currency. However, market fragmentation, political divisions and heterogenous legal frameworks continue to constrain this prospect. Sustaining Europe\u2019s economic and geopolitical standing in the face of demographic, technological, and market pressures requires a coherent reform agenda aimed at deepening integration, improving policy coordination and communication, preserving economic openness, and managing the social consequences of economic transformation.",
      doi: "10.65644/EIIE.079.01.0001",
      volume: 79, issue: 1, year: 2026, month: "February",
      pages: "1-26",
      jel: ["E02", "F02", "F15"],
    ...
    },
    {
      ...
      authors: [{ name: "Elena Seghezza", affiliation: "Department of Political Science, University of Genoa, Italy" }],
      abstract: "This paper examines the relationship between financial cycles and monetary policy, analyzing how central banks can better integrate financial stability considerations into their policy frameworks.",
      doi: "10.65644/EIIE.079.01.0027",
      volume: 79, issue: 1, year: 2026, month: "February",
      pages: "27-36",
      jel: ["E52", "E58", "G01"],
      keywords: ["Financial Cycles", "Monetary Policy", "Central Banking"],
    },
    {
      id: 1467,
      title: "Clouds on the Horizon of the Global Economy: The Importance of Taking a Long View",
      authors: [{ name: "Claudio Borio", affiliation: "Bank for International Settlements - Basel, Switzerland" }],
      abstract: "This paper argues for the importance of taking a long-term perspective when analyzing the global economy, examining structural trends that may shape economic outcomes over the coming decades.",
      doi: "10.65644/EIIE.079.01.0037",
      volume: 79, issue: 1, year: 2026, month: "February",
      pages: "37-50",
      jel: ["E60", "F01", "F40"],
      keywords: ["Global Economy", "Long-term Trends", "Economic Outlook"],
    },
    {
      id: 1468,
      title: "Artificial Intelligence and Transfer Pricing: A Multilayer Network Model for Compliance and Risk Mitigation",
      authors: [{ name: "Roberto Moro-Visconti", affiliation: "Department of Economics and Business Management Sciences, Universit\u00e0 Cattolica del Sacro Cuore, Milan - Italy" }],
      abstract: "This paper develops a multilayer network model that integrates artificial intelligence techniques with transfer pricing compliance frameworks, offering new tools for risk mitigation in multinational enterprises.",
      doi: "10.65644/EIIE.079.01.0051",
      volume: 79, issue: 1, year: 2026, month: "February",
      pages: "51-90",
      jel: ["F23", "H26", "O33"],
      keywords: ["Artificial Intelligence", "Transfer Pricing", "Network Model"],
    },
    {
      id: 1469,
      title: "Factor Shares, Redistribution and Growth in a Captured Democracy",
      authors: [{ name: "Andrea Vindigni", affiliation: "DISPI, Department of Political Sciences, University of Genova, Italy" }],
      abstract: "This paper analyzes the interplay between factor shares, redistributive policies, and economic growth in political systems characterized by regulatory capture and institutional constraints.",
      doi: "10.65644/EIIE.079.01.0091",
      volume: 79, issue: 1, year: 2026, month: "February",
      pages: "91-142",
      jel: ["D72", "E25", "O43"],
      keywords: ["Factor Shares", "Redistribution", "Economic Growth", "Democracy"],
    },
  ],
};

// Editor's Choice articles (from the carousel on the current site)
export const EDITORS_CHOICE: Article[] = [
  {
    id: 1001,
    title: "Considerazioni sui concetti di \u201cvalore economico\u201d e di \u201cvalore-lavoro\u201d",
    authors: [{ name: "Napoleoni Claudio" }],
    abstract: "",
    volume: 10, issue: 0, year: 1957, month: "August",
    pages: "",
    jel: ["J20", "J30"],
  ...
  {
    id: 1002,
    title: "Teoria della localizzazione e teoria del commercio internazionale",
    authors: [{ name: "Stolper Wolfgang F." }],
    abstract: "",
    volume: 9, issue: 0, year: 1956, month: "",
    pages: "",
    jel: ["F10", "F14"],
    keywords: ["International Trade", "Location Theory"],
  },
  {
    id: 1003,
    title: "Growth, Terms of Trade and Comparative Advantage",
    authors: [{ name: "Bhagwati Jagdish" }],
    abstract: "",
    volume: 12, issue: 3, year: 1959, month: "August",
    pages: "",
    jel: ["F10", "F43"],
    keywords: ["Growth", "Trade", "Comparative Advantage"],
  },
  {
    id: 1004,
    title: "Mauro Fasiani",
    authors: [{ name: "Cosciani Cesare" }],
    abstract: "",
    volume: 3, issue: 0, year: 1950, month: "November",
    pages: "",
    jel: ["G10", "G40"],
    keywords: ["Scienza delle finanze", "Sociologia"],
  },
  {
    id: 1005,
    title: "Problems of the Return to Convertibility",
    authors: [{ name: "Jacobsson Per" }],
    abstract: "",
    volume: 8, issue: 0, year: 1955, month: "February",
    pages: "",
    jel: ["E52"],
    keywords: ["Convertibility", "Monetary Policy"],
  },
];
